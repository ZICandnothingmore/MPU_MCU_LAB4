...
void Task_Init(){
	  HAL_GPIO_WritePin(GPIOA, RED_LED_Task_1_Pin|RED_LED_Task_3_Pin|RED_LED_Task_5_Pin, LED_OFF);
	  HAL_GPIO_WritePin(GPIOA, RED_LED_Task_2_Pin|RED_LED_Task_4_Pin, LED_ON);
